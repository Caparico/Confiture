<?php
/**
 * Confiture functions and definitions.
 *
...
if ( ! function_exists( 'confiture_setup' ) ) :
/**
 ...
 */
function confiture_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Confiture, use a find and replace
	 * to change 'confiture' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'confiture', get_template_directory() . '/languages' );
	...
	add_image_size('confiture-small-thumb', 300, 150, true);

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'confiture' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'confiture_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'confiture_setup' );
 ...
 */
function confiture_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'confiture_content_width', 640 );
}
add_action( 'after_setup_theme', 'confiture_content_width', 0 );
 ...
 */
function confiture_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'confiture' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'confiture' ),
...
add_action( 'widgets_init', 'confiture_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'confiture_scripts' );
